package com.dogmaweb.springframework.web.servlet.support;
...
import com.dogmaweb.springframework.web.bind.support.ConversationalSessionAttributeStore;

/**
 * This processor is used to add the conversation id as a hidden field on the form If the conversation id exists on the
 * request.
 * 
